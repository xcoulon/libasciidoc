...
// 			}
// 			a.appendBlock(block)
// 		case types.OrderedListElement, types.UnorderedListItem, types.LabeledListItem, types.CalloutListItem:
...
// 	parentItem := (*parentList).LastElement()
...
// 		return a.appendOrderedListElement(&item)
...
// func (a *listArranger) appendOrderedListElement(item *types.OrderedListElement) error {
// 	maxLevel := 0
